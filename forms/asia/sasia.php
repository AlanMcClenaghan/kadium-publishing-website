...
$from_addr = $_POST['P_09_email'];
// add the from address
$sendfrom = 'reg2009@kadiumpublishing.com';
ini_set("sendmail_from", $sendfrom);
$headers  = "From: $from_addr\r\n";
// send the emails
if (isset($registration_addr))
	$sent = mail($registration_addr, "South Asian Wireless Communications Registration Form from <$from_addr>", $msg1, $headers, '-f' . $sendfrom);
if (isset($sponsor_addr))
	$sent = mail($sponsor_addr, "South Asian Wireless Communications Draw Form submission", $msg2, $headers, '-f' . $sendfrom);
// redirect
if ($sent) {
