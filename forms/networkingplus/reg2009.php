...
if (isset($registration_addr))
	$sent = mail($registration_addr, "Networking+ Registration Form from <$from_addr>", $msg1, $headers, '-f' . $sendfrom);
if (isset($sponsor_addr))
	$sent = mail($sponsor_addr, "Networking+ Draw Form submission", $msg2, $headers, '-f' . $sendfrom);
// redirect
if ($sent) {
